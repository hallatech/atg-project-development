...
--  @version $Id: //product/DCS/version/11.3/templates/DCS/sql/order_ddl.xml#1 $$Change: 1385662 $
...
create table dcspp_tax_price (
	...
	value_added_tax	number(19,7)	null,
	misc_tax	number(19,7)	null,
	is_tax_included	number(1)	null
...
create table dcspp_misc_taxinfo (
	amount_info_id	varchar2(40)	not null,
	tax_name	varchar2(40)	not null,
	tax_value	number(19,7)	not null
,constraint dcspp_misc_tax_p primary key (amount_info_id,tax_name)
,constraint dcspp_mscmnt_nfd_f foreign key (amount_info_id) references dcspp_amount_info (amount_info_id));

create index misc_tax_info_idx on dcspp_misc_taxinfo (amount_info_id);
